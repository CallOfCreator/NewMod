...
public class EnergyTab : IDebugTab
{
    ...
    public void BuildGUI()
    {
        ...
        if (GUILayout.Button("Capture Aggression")) CaptureEnergy(thief, EnergyCategory.Aggression, false);
        if (GUILayout.Button("Capture Control")) CaptureEnergy(thief, EnergyCategory.Control, false);
        if (GUILayout.Button("Capture Intelligence")) CaptureEnergy(thief, EnergyCategory.Intelligence, false);
        if (GUILayout.Button("Capture Mobility")) CaptureEnergy(thief, EnergyCategory.Mobility, false);
        if (GUILayout.Button("Capture Protection")) CaptureEnergy(thief, EnergyCategory.Protection, false);
        if (GUILayout.Button("Add Raw Energy")) CaptureEnergy(thief, EnergyCategory.Aggression, true);
        if (GUILayout.Button("Complete Requirements")) CompleteEnergyThiefRequirements(thief);
        if (GUILayout.Button("Cancel Siphon")) EnergyThief.RpcConfirmCancelSiphon(PlayerControl.LocalPlayer, thief.PlayerId);
