...
public class PlayerTab : IDebugTab
{
    ...
    public void BuildGUI()
    {
        ...
        if (GUILayout.Button("Revive"))
            Utils.HandleRevive(PlayerControl.LocalPlayer, SelectedPlayer.PlayerId, RoleTypes.Crewmate, SelectedPlayer.GetTruePosition().x, SelectedPlayer.GetTruePosition().y);
