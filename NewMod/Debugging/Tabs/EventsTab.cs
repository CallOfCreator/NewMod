...
public class EventsTab : IDebugTab
{
    ...
    public void BuildGUI()
    {
        ...
        if (GUILayout.Button("Start")) GeneralEventManager.StartCycle();

        if (GUILayout.Button("Stop")) GeneralEventManager.StopCycle();

        if (GUILayout.Button("End Current Event")) GeneralEventManager.ForceEnd();
