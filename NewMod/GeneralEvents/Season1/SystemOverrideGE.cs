...
namespace NewMod.GeneralEvents.Season1
{
    public class SystemOverrideGE : IGeneralEvent
    {
        ...
        public IEnumerator CoOverrideSystems()
        {
            while (Active)
            {
                yield return new WaitForSeconds(UnityEngine.Random.Range(3.2f, 5.2f));
                ...
                ShipStatus.Instance.RpcCloseDoorsOfType(rooms[UnityEngine.Random.Range(0, rooms.Length)].RoomId);
            }
        }
    }
}